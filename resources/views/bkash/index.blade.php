...
<body class="bg-gray-50 min-h-screen">
    ...
    <div class="max-w-2xl mx-auto py-12 px-4">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-pink-600 text-white text-2xl font-bold mb-3">
                b
            </div>
            <h1 class="text-2xl font-bold text-gray-800">bKash Sandbox Payment</h1>
            <p class="text-gray-500 text-sm mt-1">Test the tokenized checkout flow end to end</p>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-8">
            ...
            <form method="POST" action="{{ route('bkash.pay') }}" class="space-y-4">
                @csrf
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="w-full pl-8 pr-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:border-transparent"
                        >
                    </div>
                </div>

                <button type="submit"
                    class="w-full bg-pink-600 hover:bg-pink-700 transition text-white font-semibold py-3 rounded-xl shadow-sm">
                    Pay with bKash
                </button>
            </form>
        </div>
                    ...
                    <table class="w-full text-sm">
                        <thead>
                            <tr class="text-left text-gray-400 uppercase text-xs bg-gray-50">
                                ...
                                <th class="px-6 py-3 font-medium">Trx ID</th>
