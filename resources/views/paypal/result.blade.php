        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
            ...
            @if ($transaction)
                <div class="text-left bg-gray-50 rounded-xl p-4 space-y-2 mb-6 text-sm">
                    ...
                    <div class="flex justify-between">
                        <span class="text-gray-400">Capture ID</span>
                        <span class="text-gray-700 font-medium">{{ $transaction->capture_id ?? '—' }}</span>
                    </div>
                    <div class="flex justify-between">
            ...
            <a href="{{ route('paypal.index') }}"
                class="block w-full bg-blue-700 hover:bg-blue-800 transition text-white font-semibold py-3 rounded-xl">
                Back to Home
            </a>
        </div>
